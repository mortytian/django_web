# Generated by Django 2.2.5 on 2019-12-04 06:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bookid', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spoken', models.IntegerField(blank=True, db_column='SPOKEN', null=True)),
                ('fiction', models.BigIntegerField(blank=True, db_column='FICTION', null=True)),
                ('magazine', models.BigIntegerField(blank=True, db_column='MAGAZINE', null=True)),
                ('newspaper', models.IntegerField(blank=True, db_column='NEWSPAPER', null=True)),
                ('academic', models.IntegerField(blank=True, db_column='ACADEMIC', null=True)),
            ],
            options={
                'db_table': 'coca',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('word', models.TextField(blank=True, null=True)),
                ('learn_time', models.CharField(blank=True, max_length=40, null=True)),
